...
(function($)
{
	...
	$.Redactor.opts = {
		...
		buttons: ['html', 'formatting', 'bold', 'italic', 'deleted', 'unorderedlist', 'orderedlist',
				  'outdent', 'superscript', 'indent', 'image', 'file', 'link', 'alignment', 'horizontalrule'], // + 'underline'
		...
		activeButtons: ['deleted', 'italic', 'bold', 'superscript', 'underline', 'unorderedlist', 'orderedlist',
	...
	Redactor.fn = $.Redactor.prototype = {
		...
		button: function()
		{
			return {
				...
				{
					var iconClass = 're-icon re-' + btnName;
					if(btnName == 'superscript') {
						iconClass += ' fa-redactor-btn';
					}
					
					var $button = $('<a href="#" class="' + iconClass + '" rel="' + btnName + '" />').attr('tabindex', '-1');

					if(btnName == 'superscript')
					{
						$button.html('<i class="fa fa-superscript"></i>');
					}
			...
			return {
				init: function()
				{
					return {
						...
						superscript:
						{
							title: this.lang.get('superscript'),
							func: 'inline.format'
						},
						deleted:
						{
