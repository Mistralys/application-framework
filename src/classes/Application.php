...
class Application
{
    const ERROR_CANNOT_CREATE_TEMP_FOLDER = 1199543001;
    const ERROR_CLASS_FILE_NOT_FOUND = 1199543002;
    const ERROR_NO_USER_PRIOR_TO_SESSION = 1199543003;
    const ERROR_CLASS_NOT_FOUND = 1199543004;
    const ERROR_EMPTY_PAGE_ID = 1199543005;
    const ERROR_APPLICATION_NOT_STARTED = 1199543006; 
    const ERROR_DRIVER_DID_NOT_GENERATE_CONTENT = 1199543007;
    const ERROR_CANNOT_CREATE_STORAGE_FOLDER = 1199543008;
    const ERROR_TRAIT_FILE_NOT_FOUND = 1199543009;
    const ERROR_TRAIT_CLASS_NOT_FOUND = 1199543010;
    const ERROR_CANNOT_SET_EXECUTION_TIME = 1199543011;
    const ERROR_CANNOT_SET_MEMORY_LIMIT = 1199543012;
    const ERROR_INVALID_RUN_MODE = 1199543013;
    const ERROR_SCRIPT_RUN_MODE_NO_TYPE_SET = 1199543014; 
    const ERROR_NO_RUN_MODE_SET = 1199543015;
    const ERROR_PHP_FILE_SYNTAX_ERRORS = 1199543016;
    const ERROR_CALLBACK_NOT_CALLABLE = 1199543017;
    const ERROR_SESSION_NOT_AVAILABLE_YET = 1199543018;
    ...
    */
    ...
    public function start(Application_Driver $driver) : void
    {
        ...
        else if(APP_RUN_MODE == self::RUN_MODE_SCRIPT)
        {
        }
        else
        {
