...
namespace Application\CacheControl\Admin\Screens;
 ...
 * @subpackage CacheControl
 */
class CacheControlMode extends BaseMode implements DevelModeInterface
{
    use DevelModeTrait;

    public const string URL_NAME = 'cache-control';
    public const string COL_ID = 'id';
    public const string COL_LABEL = 'label';
    public const string COL_SIZE = 'size';
    public const string GRID_NAME = 'dev-cache-control';
    ...
    {
        return DevScreenRights::SCREEN_CACHE_CONTROL;
    }
    ...
    private function createDataGrid() : UI_DataGrid
    {
        ...
        $grid->addAction(
            ...
            ->makeDangerous()
            ->setCallback($this->handle_multiClearCache(...));
