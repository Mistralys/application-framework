 ...
 * @subpackage Revisionables
 */
interface RevisionableFilterCriteriaInterface extends DBHelperFilterCriteriaInterface
{
    public const string FILTER_INCLUDE_STATES = 'include_state';
    public const string FILTER_EXCLUDE_STATES = 'exclude_state';
