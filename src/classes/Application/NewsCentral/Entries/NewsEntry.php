...
use Application\NewsCentral\Admin\Screens\Mode\ViewArticle\BaseArticleSettingsScreen;
...
class NewsEntry extends DBHelper_BaseRecord
{
    ...
    public function adminURL() : NewsEntryAdminURLs
    {
        return new NewsEntryAdminURLs($this);
    }
