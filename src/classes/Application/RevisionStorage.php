...
abstract class Application_RevisionStorage implements ArrayAccess, Application_Interfaces_Eventable
{
    ...
    const ERROR_REVISION_DOES_NOT_EXIST = 15557001;
    const ERROR_COPYTO_NOT_IMPLEMENTED = 15557002;
    const ERROR_CANNOT_SET_KEY_UNKNOWN_REVISION = 15557003;
    const ERROR_CANNOT_SET_KEYS_UNKNOWN_REVISION = 15557004;
    const ERROR_INVALID_KEY_LOADER_CALLBACK = 15557005;
