...
class ResultsSubmode extends BaseRecordListSubmode implements RenamerSubmodeInterface
{
    ...
    {
        return RenamerScreenRights::SCREEN_RENAMER_RESULTS;
    }
    ...
    {
        $this->config = ConfigurationSubmode::getConfig();
    }
    ...
    private function renderMatchedText(RenamerRecord $item) : string
    {
        ...
        foreach ($parts as $index => $part) {
            if ($index % 2 === 1) {
                ...
                $out .= sb()->bold(sb()->warning($this->escapeWithWbr($part)));
            } else {
