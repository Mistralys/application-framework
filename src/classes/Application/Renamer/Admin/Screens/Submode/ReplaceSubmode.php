...
class ReplaceSubmode extends BaseSubmode implements RenamerSubmodeInterface
{
    ...
    {
        return RenamerScreenRights::SCREEN_RENAMER_REPLACE;
    }
    ...
    {
        $this->config = ConfigurationSubmode::requireConfig();
    ...
    {
        ResultsSubmode::configureSubline($this->renderer, $this->config);
    ...
    private function handleReplace(string $replace) : void
    {
        ...
        ConfigurationSubmode::clearConfig();
