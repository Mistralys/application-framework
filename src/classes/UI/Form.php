...
{
    const ERROR_DUPLICATE_ELEMENT_ID = 45524001;
    const ERROR_INVALID_FORM_DATA = 45524002;
    const ERROR_UNKNOWN_REGEX_HINT = 45524003;
    const ERROR_UNKNOWN_EVENT_HANDLER = 45524004;
    const ERROR_INVALID_EVENT_HANDLER = 45524005;
    const ERROR_INVALID_LENGTH_LIMIT = 45524006;
    const ERROR_ELEMENT_HAS_NO_ID = 45524007;
    const ERROR_MINMAX_VALUES_EMPTY = 45524008;
    const ERROR_INVALID_MINMAX_VALUES = 45524009;
    const ERROR_MINMAX_VALUES_NOT_A_NUMBER = 45524010;
    const ERROR_OBSOLETE_IMAGE_ELEMENT = 45524011;
    const ERROR_INVALID_RENDER_CALLBACK = 45524012; 
    const ERROR_UNHANDLED_SUBMIT_HANDLER_SUBJECT = 45524013;
    const ERROR_INVALID_FORM_RENDERER = 45524014;
    const ERROR_INVALID_DATEPICKER_ELEMENT = 45524015;
    ...
    * @return HTML_QuickForm2_Element_InputText
    */
    public function addHTML(string $html, ?HTML_QuickForm2_Container $container = null) : HTML_QuickForm2_Element_InputText
    {
        return $this->addDummyElement($html, 'html', $container);
    }
    ...
    */
    ...
    protected function addElementHTML($position, HTML_QuickForm2_Element $element, $html, $whenFrozen=false)
    {
