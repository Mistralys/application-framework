...
```
###  Path: `/src/classes/DBHelper/README.md`

```md
# Module: DBHelper - Database Abstraction and Record Collections

There are two main parts to the DBHelper module:

1. [The Database Abstraction](./Docs/dbhelper-database-abstraction.md) - Classes for manual database operations
2. [The Record Collections](./Docs/dbhelper-record-collections.md) - Classes for handling database-stored records 
...
- Public API: YES
```
_SOURCE: DBHelper Documentation_
# DBHelper Documentation
```
// Structure of documents
└── src/
    └── classes/
...
```
###  Path: `/src/classes/DBHelper/Docs/dbhelper-database-abstraction.md`

```md
## Database abstraction

The `DBHelper` class is a static class with methods to access the
application's database, as well as general-purpose utility methods.
It is used to run custom queries against the database.


```
###  Path: `/src/classes/DBHelper/Docs/dbhelper-record-collections.md`
