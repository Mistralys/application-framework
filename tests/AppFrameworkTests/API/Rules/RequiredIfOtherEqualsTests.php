...
final class RequiredIfOtherEqualsTests extends APITestCase
{
    public function test_makeTargetNotRequired() : void
    {
        ...
        $this->assertTrue($paramB->isRequired(), 'No changes to Param B, it can be freely set as required or not.');
    }

    public function test_ignoreWhenSetToAnotherValue() : void
    {
        ...
        $this->assertFalse($paramA->isRequired(), 'Param A should not be required, since Param B\'s value is not the trigger value.');
        $this->assertFalse($paramB->isRequired(), 'No changes to Param B, it can be freely set as required or not.');
    }

    public function test_makeRequiredWhenSet() : void
    {
        $_REQUEST['paramA'] = 'valueA';
        $_REQUEST['paramB'] = 'triggerValue';
